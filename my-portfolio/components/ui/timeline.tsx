...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-background dark:bg-background pt-60 pb-50 font-sans md:px-10"
      ref={containerRef}
    >
      <div className="w-full px-4 md:px-8 lg:px-10 grid place-items-center">
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-background via-foreground to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
