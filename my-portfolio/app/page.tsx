...
// const images = slugs.map((slug) => `https://cdn.simpleicons.org/${slug}/${slug}`);
  ...
  useEffect(() => {
    function update() {
      ...
      if (w < 640) setCloudSize(260)
      else if (w < 1024) setCloudSize(380)
      else setCloudSize(520)
    }
    update()
        ...
        <div className="p-6 space-y-2">
          ...
          <div className="mt-3">
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              <ShinyButton className="shrink-0 whitespace-nowrap px-2 py-0.5 text-[10px] sm:px-3 sm:py-1 sm:text-xs">Python</ShinyButton>
              <ShinyButton className="shrink-0 whitespace-nowrap px-2 py-0.5 text-[10px] sm:px-3 sm:py-1 sm:text-xs">Flask</ShinyButton>
              <ShinyButton className="shrink-0 whitespace-nowrap px-2 py-0.5 text-[10px] sm:px-3 sm:py-1 sm:text-xs">React</ShinyButton>
              <ShinyButton className="shrink-0 whitespace-nowrap px-2 py-0.5 text-[10px] sm:px-3 sm:py-1 sm:text-xs">Next</ShinyButton>
              <ShinyButton className="shrink-0 whitespace-nowrap px-2 py-0.5 text-[10px] sm:px-3 sm:py-1 sm:text-xs">TensorFlow</ShinyButton>
              <ShinyButton className="shrink-0 whitespace-nowrap px-2 py-0.5 text-[10px] sm:px-3 sm:py-1 sm:text-xs">Firebase</ShinyButton>
            </div>
          </div>
        </div>
      </MagicCard>
      ...
      <MagicCard className="h-full">
        <div className="p-6 space-y-2">
          ...
          <div className="mt-3">
            <p className="text-sm font-semibold text-foreground">Technologies</p>
            <div className="mt-2 flex flex-wrap gap-2">
              <ShinyButton className="shrink-0 whitespace-nowrap px-2 py-0.5 text-[10px] sm:px-3 sm:py-1 sm:text-xs">JavaScript</ShinyButton>
              <ShinyButton className="shrink-0 whitespace-nowrap px-2 py-0.5 text-[10px] sm:px-3 sm:py-1 sm:text-xs">MongoDB</ShinyButton>
              <ShinyButton className="shrink-0 whitespace-nowrap px-2 py-0.5 text-[10px] sm:px-3 sm:py-1 sm:text-xs">Expres</ShinyButton>
              <ShinyButton className="shrink-0 whitespace-nowrap px-2 py-0.5 text-[10px] sm:px-3 sm:py-1 sm:text-xs">React</ShinyButton>
              <ShinyButton className="shrink-0 whitespace-nowrap px-2 py-0.5 text-[10px] sm:px-3 sm:py-1 sm:text-xs">Node</ShinyButton>
            </div>
      ...
      <MagicCard className="h-full">
        <div className="p-6 space-y-2">
          ...
          <div className="mt-3">
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              <ShinyButton className="shrink-0 whitespace-nowrap px-2 py-0.5 text-[10px] sm:px-3 sm:py-1 sm:text-xs">Python</ShinyButton>
              <ShinyButton className="shrink-0 whitespace-nowrap px-2 py-0.5 text-[10px] sm:px-3 sm:py-1 sm:text-xs">Django</ShinyButton>
              <ShinyButton className="shrink-0 whitespace-nowrap px-2 py-0.5 text-[10px] sm:px-3 sm:py-1 sm:text-xs">React</ShinyButton>
              <ShinyButton className="shrink-0 whitespace-nowrap px-2 py-0.5 text-[10px] sm:px-3 sm:py-1 sm:text-xs">MongoDB</ShinyButton>
            </div>
      ...
      <MagicCard className="h-full">
        <div className="p-6 space-y-2">
          ...
          <div className="mt-3">
            <p className="text-sm font-semibold text-foreground">Technologies</p>
            <div className="mt-2 flex flex-wrap gap-2">
              <ShinyButton className="shrink-0 whitespace-nowrap px-2 py-0.5 text-[10px] sm:px-3 sm:py-1 sm:text-xs">Express</ShinyButton>
              <ShinyButton className="shrink-0 whitespace-nowrap px-2 py-0.5 text-[10px] sm:px-3 sm:py-1 sm:text-xs">PostgreSQL</ShinyButton>
              <ShinyButton className="shrink-0 whitespace-nowrap px-2 py-0.5 text-[10px] sm:px-3 sm:py-1 sm:text-xs">Sequelize</ShinyButton>
            </div>
            ...
            <div className="mt-10 space-y-6">
              ...
              <div className="grid grid-cols-12 items-center gap-6">
                ...
                <div className="col-span-9">
                  <div className="flex gap-3 overflow-x-auto pb-2 items-center justify-start">
                    <ShinyButton className="shrink-0 px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm md:px-5 md:py-2 md:text-base lg:px-6 lg:py-3">Git</ShinyButton>
                    <ShinyButton className="shrink-0 px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm md:px-5 md:py-2 md:text-base lg:px-6 lg:py-3">GitHub</ShinyButton>
                    <ShinyButton className="shrink-0 px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm md:px-5 md:py-2 md:text-base lg:px-6 lg:py-3">Docker</ShinyButton>
                    <ShinyButton className="shrink-0 px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm md:px-5 md:py-2 md:text-base lg:px-6 lg:py-3">VS Code</ShinyButton>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-12 items-center gap-6">
                ...
                <div className="col-span-9">
                  <div className="flex gap-3 overflow-x-auto pb-2 items-center justify-start">
                    <ShinyButton className="shrink-0 px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm md:px-5 md:py-2 md:text-base lg:px-6 lg:py-3">React</ShinyButton>
                    <ShinyButton className="shrink-0 px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm md:px-5 md:py-2 md:text-base lg:px-6 lg:py-3">Next.js</ShinyButton>
                    <ShinyButton className="shrink-0 px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm md:px-5 md:py-2 md:text-base lg:px-6 lg:py-3">TypeScript</ShinyButton>
                    <ShinyButton className="shrink-0 px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm md:px-5 md:py-2 md:text-base lg:px-6 lg:py-3">Tailwind</ShinyButton>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-12 items-center gap-6">
                ...
                <div className="col-span-9">
                  <div className="flex gap-3 overflow-x-auto pb-2 items-center justify-start">
                    <ShinyButton className="shrink-0 px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm md:px-5 md:py-2 md:text-base lg:px-6 lg:py-3">Node.js</ShinyButton>
                    <ShinyButton className="shrink-0 px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm md:px-5 md:py-2 md:text-base lg:px-6 lg:py-3">Express</ShinyButton>
                    <ShinyButton className="shrink-0 px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm md:px-5 md:py-2 md:text-base lg:px-6 lg:py-3">Prisma</ShinyButton>
                    <ShinyButton className="shrink-0 px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm md:px-5 md:py-2 md:text-base lg:px-6 lg:py-3">Postgres</ShinyButton>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-12 items-center gap-6">
                ...
                <div className="col-span-9">
                  <div className="flex gap-3 overflow-x-auto pb-2 items-center justify-start">
                    <ShinyButton className="shrink-0 px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm md:px-5 md:py-2 md:text-base lg:px-6 lg:py-3">Figma</ShinyButton>
                    <ShinyButton className="shrink-0 px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm md:px-5 md:py-2 md:text-base lg:px-6 lg:py-3">Vercel</ShinyButton>
                    <ShinyButton className="shrink-0 px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm md:px-5 md:py-2 md:text-base lg:px-6 lg:py-3">Firebase</ShinyButton>
                    <ShinyButton className="shrink-0 px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm md:px-5 md:py-2 md:text-base lg:px-6 lg:py-3">Jest</ShinyButton>
                  </div>
                </div>
              </div>
            </div>
